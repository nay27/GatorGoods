defmodule BackendWeb.ItemControllerTest do
  ...
  @create_attrs %{description: "some description", onlyVisibleToFaculty: true, price: 42, status: "some status", title: "some title"}
  ...
  def fixture(:item) do
    {:ok, item} = Users.create_item(@create_attrs)
    item
  end
